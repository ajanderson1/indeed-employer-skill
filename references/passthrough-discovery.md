...
#### Inline resume metadata discovery
No typed CV/PDF download tool is currently exposed. If resume GraphQL metadata needs
research for the future proxy-download design (issue #29), use `findRCPMatches` with
